...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: #fff; color: #111; line-height: 1.6; padding: 20px;">
  <header style="border-bottom: 1px solid #e5e5e5; padding: 16px 24px; background: #fafafa; margin: -20px -20px 24px;">
  ...
  <main style="max-width: 840px; margin: 0 auto;">
    <div style="background: #fafafa; border: 1px solid #e5e5e5; border-radius: 4px; padding: 20px; margin-bottom: 16px;">
